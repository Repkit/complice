 ...
 */
define ('PDF_HEADER_LOGO', 'complice_logo.png');

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 75);
...
define ('PDF_HEADER_X', 25);
define ('PDF_HEADER_Y', 25);
define ('PDF_HEADER_LOGO_W', 73);
define ('PDF_HEADER_LOGO_H', 27);
